...
El codigo es abierto y está disponible en \url{https://github.com/ushikawa93/signal_ classifier_with_rtos_stm32}.
...
El modelo se inicializa antes de lanzar las tareas, mediante la función \texttt{neai\_ classification\_init()} provista en la librería.
...
Inicialmente el sistema fue desarrollado utilizando una arquitectura secuencial, con modos configurados a través de \texttt{\#defines}. Esta implementación preliminar está disponible en \url{https://github.com/ushikawa93/signal_classifier_stm32}.
...
\item Investigar la causa de la baja robustez de la clase OndaCuadrada ante niveles de ruido elevados. En este sentido puede considerarse reentrenar el sistema con datos ruidosos.
